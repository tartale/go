...
// 	assert.Nil(t, err)
// 	assert.Equal(t, `{"foo":"foo","bar":{"foo":"foo","bar":"1976-07-31"}}`, string(testJson))
...
// 	testJson := `{"foo":"foo","bar":{"foo":"foo","bar":"1976-07-31"}}`
...
// 	testStruct := testStructWithAnyField.Bar.(TestStruct)
// 	assert.Nil(t, err)
// 	assert.Equal(t, 1976, testStruct.Bar.Year())
// 	assert.Equal(t, time.July, testStruct.Bar.Month())
// 	assert.Equal(t, 31, testStruct.Bar.Day())
